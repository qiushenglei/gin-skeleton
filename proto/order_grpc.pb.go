...
type OrderServerClient interface {
	// 获取列表
	FindAll(ctx context.Context, in *FindAllRequest, opts ...grpc.CallOption) (*FindAllReply, error)
}
...
func (c *orderServerClient) FindAll(ctx context.Context, in *FindAllRequest, opts ...grpc.CallOption) (*FindAllReply, error) {
	out := new(FindAllReply)
	err := c.cc.Invoke(ctx, "/pdfiles.user.OrderServer/FindAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServerServer interface {
	// 获取列表
	FindAll(context.Context, *FindAllRequest) (*FindAllReply, error)
...
func (UnimplementedOrderServerServer) FindAll(context.Context, *FindAllRequest) (*FindAllReply, error) {
...
func _OrderServer_FindAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindAllRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServerServer).FindAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pdfiles.user.OrderServer/FindAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServerServer).FindAll(ctx, req.(*FindAllRequest))
	}
...
var OrderServer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pdfiles.user.OrderServer",
	HandlerType: (*OrderServerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "FindAll",
			Handler:    _OrderServer_FindAll_Handler,
		},
	},
