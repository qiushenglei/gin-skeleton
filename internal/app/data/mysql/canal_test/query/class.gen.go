...
func newClass(db *gorm.DB, opts ...gen.DOOption) class {
	...
	_class.ID = field.NewUint32(tableName, "id")
	_class.ClassName = field.NewString(tableName, "class_name")
	_class.Grade = field.NewString(tableName, "grade")
	_class.AddTime = field.NewTime(tableName, "add_time")
...
func (c *class) updateTableName(table string) *class {
	...
	c.Grade = field.NewString(table, "grade")
...
func (c *class) WithContext(ctx context.Context) *classDo { return c.classDo.WithContext(ctx) }

func (c class) TableName() string { return c.classDo.TableName() }

func (c class) Alias() string { return c.classDo.Alias() }

func (c class) Columns(cols ...field.Expr) gen.Columns { return c.classDo.Columns(cols...) }
