...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Label = field.NewString(tableName, "label")
	_user.ClassID = field.NewUint32(tableName, "class_id")
	_user.StudentID = field.NewString(tableName, "student_id")
	_user.AddTime = field.NewTime(tableName, "add_time")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Label = field.NewString(table, "label")
	u.ClassID = field.NewUint32(table, "class_id")
	u.StudentID = field.NewString(table, "student_id")
	u.AddTime = field.NewTime(table, "add_time")
